...
| **Backend** | The browser engine behind the Daemon: **WebKit** (macOS native default) or **Chrome/Chromium** over the DevTools Protocol; chosen by `resolveBackend` (`src/backend.ts`). |
